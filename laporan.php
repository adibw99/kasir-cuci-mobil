	...
	die();
	 ...
	 echo '
		...
		<div class="col-sm-6"><table class="table table-bordered">';
		 ...
		 $sql = mysqli_query($koneksi, "SELECT count(nama_costumer), sum(total) FROM transaksi WHERE tanggal BETWEEN '$tgl1' AND '$tgl2'");
...
<?php
	  ...
	  $sql = mysqli_query($koneksi, "SELECT count(nama_costumer), sum(total) FROM transaksi WHERE tanggal='$tanggal'");
