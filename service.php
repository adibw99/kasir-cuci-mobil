...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['aksi'] )){
		...
		echo '
			...
			<div class="container">
			<div class="col-md-8">
				<h3 style="margin-bottom: -20px;">Data Master Biaya Service</h3>
	 			...
	 			echo '
				   ...
				   <tr>
					...
					<script type="text/javascript" language="JavaScript">
					 ...
					 <a href="?hlm=biaya&aksi=edit&id_service='.$row['id_service'].'" class="btn btn-warning btn-s">Edit</a>
					 <a href="?hlm=biaya&aksi=hapus&submit=yes&id_service='.$row['id_service'].'" onclick="return konfirmasi()" class="btn btn-danger btn-s">Hapus</a>
